...
pub mod lldp_v2 {
    ...
    pub mod local {
        ...
        /// lldpV2LocPortTable — the three columns below, as one subtree. Like its classic
        /// counterpart, only the simulator uses the root, to register the table apart.
        pub const LLDP_V2_LOC_PORT_TABLE: &str = "1.3.111.2.802.1.1.13.1.3.7";
